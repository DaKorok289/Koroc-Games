    ...
    <div className="arena-wrap">
      {status === "playing" && itPlayer && (
        <div className="tagger-banner">
          🔴 <strong>{itPlayer.id === user?.id ? "You are" : `${itPlayer.username} is`}</strong> the tagger!
        </div>
      )}
      ...
      <p className="pong-role">
        Move: drag/WASD/on-screen arrows. Tag passes to whoever "it" (red) touches — walls
        are obstacles. Whoever's it when the 3-minute clock runs out loses.{" "}
